<?php
   ...
   $user_id=$_SESSION['user_id'];
    ...
    if(isset($_POST['sub']))
    {
        mysqli_query($conn, "INSERT INTO `orders`(user_id, name, number, email, address, product_name, total_price, placed_on, total_product) VALUES('$user_id', '$name', '$number', '$email',  '$address', '$total_products', '$cart_total', '$placed_on', '1')") or die('query failed');
        mysqli_query($conn,"INSERT INTO `payment_status`( `user_id` , `name`, `product_name`, `price`, `payment_status`, `method`) VALUES ('$user_id','$name','$total_products','$cart_total','Panding','$method')");
...
<div class="add-products">
    ...
    <form method="post">
      <h1 style="color:white; font-size:40px;"> Debit Card payment</h1><br><br>
      <h1 style="color:white">Debit Number:</h1>
